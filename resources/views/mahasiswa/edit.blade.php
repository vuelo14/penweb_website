                        ...
                        <form method="POST" action="{{ route('mahasiswa.update', $mahasiswa->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('jk') is-invalid @enderror" id="jk" name="jk"
                                    ...
                                    <option value="Laki-laki"
                                        {{ old('jk', $mahasiswa->jk) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="Perempuan"
                                        {{ old('jk', $mahasiswa->jk) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                                @error('jk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('prodi') is-invalid @enderror" id="prodi"
                                    ...
                                    @foreach ($prodiList as $prodi)
                                        <option value="{{ $prodi }}"
                                            {{ old('prodi', $mahasiswa->prodi) == $prodi ? 'selected' : '' }}>
                                            {{ $prodi }}</option>
                                    @endforeach
                                </select>
                                @error('prodi')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror"
                                    ...
                                    value="{{ old('tgl_lahir', $mahasiswa->tgl_lahir->format('Y-m-d')) }}" required>
                                @error('tgl_lahir')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 form-check">
                                {{-- <input type="checkbox" class="form-check-input" id="nonreg" name="nonreg" {{ old('nonreg', $mahasiswa->nonreg) ? 'checked' : '' }}> --}}
